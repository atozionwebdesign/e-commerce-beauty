...
export default function Home() {
  ...
  return (
    <div className="page min-h-screen pb-5">
      ...
      <div className="main">
        <TopNav handleBagClick={handleBagClick} cart={cart} openModal={openModal}/>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} >
          {
            modalInfo == "details"
              ...
              modalInfo =="checkout"
                ? <Checkout cart = {cart}/>
                : <ShoppingCart cart={cart} setCart={setCart} handlePayClick = {handlePayClick} close={closeModal}/>
          }
