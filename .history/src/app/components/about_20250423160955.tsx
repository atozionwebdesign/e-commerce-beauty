...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p className="font-bold mt-5 mb-1 mx-auto text-center md:text-left large" style={{color:'var(--dark-olive)'}}>TECH STACK:</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="grid-cols-1">
                    <p style={{color: 'var(--dark-rose)'}} className='mx-auto text-center md:text-left'>Front-end:</p>
                ...
                <div className="grid-cols-1">
                    ...
                    <ul style={{listStyleType: 'circle'}} className="small ml-5">
                        ...
                        <li>AWS</li>
                        <li>Stripe</li>
                        <li><strong>Languages:</strong> Typescript, Javascript, Mongoose</li>
                    </ul>
                </div>
            </div>
