...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p className="mt-5 mb-3 text-center"><a style={{color: 'var(--lightblue)'}} href="https://github.com/atozionwebdesign/todoapp-prod" target="_blank"><FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></p>
        </div>
    )
}