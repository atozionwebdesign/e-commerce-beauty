...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p>Application deployed automated using GitHub actions.  Dpcler on an Amazon Elastic Compute Cloud (EC2) virtual server instance. Code repository managed and stored on the Github repository linked below.</p>
