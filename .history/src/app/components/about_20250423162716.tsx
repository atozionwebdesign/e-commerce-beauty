...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p className="mt-5 mb-3 text-center"><a href="https://github.com/atozionwebdesign/e-commerce-beauty" target="_blank"><FontAwesomeIcon icon={faGithub}></FontAwesomeIcon></a></p>
        </div>
    )
}