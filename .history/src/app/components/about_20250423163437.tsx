...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p>This is fully functioning test e-commerce mobile responsive web application. It is built using <strong>Nextjs</strong> with a <strong>Node</strong> server and <strong>MongoDB</strong> database.  Multiple API server routes are created and the front-end is customized using <strong>TailwindCSS</strong>. It is integrated with a <strong>Stripe</strong> test sandbox and deployed via an <strong></strong>AWS EC2 instance.</p>
