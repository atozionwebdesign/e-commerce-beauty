...
import { faMagnifyingGlass, faInfo, faShoppingCart, faUser } from '@fortawesome/free-solid-svg-icons';
import ICartItem from "../models/CartItem";

export default function TopNav(props: { cart: string | ICartItem[]; handleBagClick: (type: string, q?: number, item?: string) => void; openModal: (info:string) => void}) {
    const cartLength =  
        props.cart
            ? props.cart.length
            : ''
        ...
        <div className="py-5 md:sticky top-0 z-10 bg-(--off-white)">
            <div className="h-fit px-5 lg:px-10 w-full grid grid-cols-11 " >
                ...
                <div className="col-span-3 w-full h-full">
                    <p className="small cursor" onClick = {handleInfoClick}>
                        <FontAwesomeIcon icon={faInfo}></FontAwesomeIcon> ABOUT SITE
                    </p>
                </div>
