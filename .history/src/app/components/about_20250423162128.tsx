...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p>Application packaged as Docker container to assist in deployment and portability.  GitHub actions is leveraged to streamline the build and deployment on an Amazon Elastic Compute Cloud (EC2) virtual server instance. Code repository managed and stored on the Github repository linked below.</p>
