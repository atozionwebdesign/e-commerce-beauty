            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div className="grid-cols-1">
                    ...
                    <ul style={{listStyleType: 'circle'}} className="small ml-5">
                        ...
                        <li>Stripe</li>
                        <li>Docker</li>
                        <li><strong>Languages:</strong> Typescript, Javascript, Mongoose, YAL</li>
                    </ul>
                </div>
            </div>
            <p className="font-bold mt-3 mb-1 mx-auto text-center md:text-left large" style={{color:'var(--dark-olive)'}}>DEPLOYMENT DETAILS:</p>
            <p>Application deployed automated using GitHub actions on an Amazon Elastic Compute Cloud (EC2) virtual server instance. Code repository managed and stored on the Github repository linked below.</p>
