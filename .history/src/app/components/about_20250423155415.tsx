...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p>This is full a simple tasking application built using Nextjs with a Node server and MySQL database.  API routes are created for all CRUD methods. The front-end is customized using Tailwindcss.</p>
