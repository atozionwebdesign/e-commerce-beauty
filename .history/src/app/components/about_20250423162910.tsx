...
export default function About(){
    return(
        <div className='flex-1 max-h-full overflow-y-auto'>
            ...
            <p>Application packaged as Docker container to assist with deployment and portability.  <strong>GitHub Actions</strong> is leveraged to streamline the deployment process by triggering builds and deployments on every push to a specified branch.  The application is deployed to an <strong>Amazon Elastic Compute Cloud (EC2)</strong> virtual server instance and Caddy is used to securely serve the application on HTTPS. Code repository managed and stored on the Github repository linked below.</p>
