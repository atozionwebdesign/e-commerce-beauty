...
This is fully functioning test e-commerce mobile responsive web application. It is built using NexJS It is styled using [Tailwindcss](http://tailwindcss.com). 
