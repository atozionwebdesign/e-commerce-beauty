...
### Deployment Details
Application packaged as a Docker container to assist with dedeployed via SSH client on an Amazon EC2 virtual server instance. DNS and SSL configured using [Caddy Server](http://https://caddyserver.com/)
